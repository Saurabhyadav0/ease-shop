      ...
      <section className="flex flex-col lg:flex-row items-center gap-8 py-6">
        ...
        <div className="flex-1">
          ...
          <Image
            ...
            priority  // This makes sure the image loads early for better LCP
          />
        </div>
      </section>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    {[
      ...
      },
      {
        ...
        description: "Our customer support is always available to help you.",
        href: "/support",
      },
    ].map((feature, i) => (
      <Link key={i} href={feature.href}>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:bg-shop-primary/5 dark:hover:bg-shop-primary/10 cursor-pointer">
